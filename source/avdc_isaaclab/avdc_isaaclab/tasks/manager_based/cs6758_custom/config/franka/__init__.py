...
##
# Our custom "franka pick cube and drop it into basket" task
##
...
gym.register(
    id="Isaac-Basket-Cube-Franka-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": f"{__name__}.joint_pos_env_cfg:FrankaBasketCubeEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:BasketCubePPORunnerCfg",
    },
